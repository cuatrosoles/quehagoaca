        ...
        <>
            <div className="flex flex-wrap md:grid md:grid-cols-12">
                ...
                <div className="w-full md:col-span-10 space-y-2 mt-2 md:mt-0">
                    ...
                    <p className="text-sm">
                        ...
                        { (review?.text?.split(' ').length > 46) && (
                            ...
                            >
                                ...
                                { showMore ? <span><br />Mostrar menos</span> : 'More' }
                                {/* --- */}
                            </span>
                        ) }
                        {/* --- */}
                    ...
                    <p className="text-sm">
                        <span className="font-semibold">Fecha de visita:</span> { moment(review?.travel_date).format('MMMM YYYY') }
                    </p>
                    {/* --- */}
                    ...
                    { review?.owner_response && (
                        <div className="pl-3 md:pl-4 border-l border-gray-300 my-2">
                            {/* Responder Details */}
                            <p className="text-sm">
                                { review?.owner_response?.responder }, { review?.owner_response?.connection } at { place }, <span className="text-xs">respondiendo a este comentario</span>
                            </p>
                            {/* --- */}
